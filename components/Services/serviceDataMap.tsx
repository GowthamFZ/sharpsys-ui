export const servicesDataMap = {
    ...
    "CRM": [
        ...
        { id: 202, order:"02", name: "Salesforce", description:"Drive sales growth and optimize CRM with Salesforce.", img: "/images/services/servicestab/Salesforce.png" },
    ],
    "Advanced Analytics": [
        { id: 301, order:"01", name: "Consulting", description: "Expert guidance to drive strategic business growth.", img: "/images/services/servicestab/Consulting.jpg" },
        { id: 302, order:"02", name: "Data Analytics", description:"Unlock actionable insights with advanced analytics.", img: "/images/services/servicestab/Data Analytics.png" },
